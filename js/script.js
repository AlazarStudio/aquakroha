...
$(document).ready(function () {
  ...
  $(".blog_info__btns___button").click(function () {
    ...
    $(".blog_info__btns___button")
      .not(this)
      .html('Подробнее <img src="refs/Polygon 7.png" alt="">');
  ...
  function animateOnScroll() {
    $(".itemMove_1").each(function () {
      if (
        ...
        !$(this).hasClass("is_visible__itemMove_1")
      ) {
    ...
    $(".itemMove_2").each(function () {
      if (
        checkVisibility(this) &&
        !$(this).hasClass("is_visible__itemMove_2")
      ) {
    ...
    $(".itemMove_3").each(function () {
      if (
        checkVisibility(this) &&
        !$(this).hasClass("is_visible__itemMove_3")
      ) {
    ...
    $(".rightSide_itemMove_1").each(function () {
      if (
        checkVisibility(this) &&
        !$(this).hasClass("is_visible__rightSide_itemMove_1")
      ) {
    ...
    $(".rightSide_itemMove_2").each(function () {
      if (
        checkVisibility(this) &&
        !$(this).hasClass("is_visible__rightSide_itemMove_2")
      ) {
    ...
    $(".rightSide_itemMove_3").each(function () {
      if (
        checkVisibility(this) &&
        !$(this).hasClass("is_visible__rightSide_itemMove_3")
      ) {
